 ...
 * Note: §6.2.2 uses ASCII double quotes for inline command-word references
 * ("встал", "лёг") and guillemets for descriptive labels («дневной сон»).
 */

/** Evening "лёг" acknowledgement — awaiting morning "встал". Per §6.2.2: ASCII quotes for command words. */
...
/** Morning "встал" without prior "лёг" — clarifying message per §5 US-2 AC#5. Per §6.2.2: ASCII quotes for command words. */
...
/** Sanity-floor warn — duration < 30 min. Per §6.2.2 C18 block. Guillemets per spec for descriptive label. */
...
/** Modality OFF — per §6.2.2 "silent". DO NOT use in production reply path; kept for debug only. */
